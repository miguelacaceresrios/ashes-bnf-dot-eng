...
<table border="1" cellpadding="15" cellspacing="0" bgcolor="#FEF7E0" width="100%">
  <tr>
    <td>
      ...
      <p>
        En estos archivos descansan los secretos de mi <em>window manager</em>, los pactos con el emulador de terminal 
        y las runas que invocan a <code>vim</code>. Navegad con cuidado, viajero, pues modificar un <code>.rc</code> 
        sin conocimiento puede invocar errores arcanos.
      </p>
      <p>
        Para usar estos dotfiles, clona este repositorio con <code>git clone</code> 
